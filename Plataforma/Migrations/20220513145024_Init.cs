        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessagesPosition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastLogin = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RecoverPasswordToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecoverPasswordTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GlobalSettings_TestProperty = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FileGroupId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Errors_IdentityUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                table: "IdentityUsers",
                columns: new[] { "Id", "AccessFailedCount", "Active", "ConcurrencyStamp", "CreationTime", "Email", "EmailConfirmed", "LastLogin", "LockoutEnabled", "LockoutEnd", "Master", "MessagesPosition", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "RecoverPasswordTime", "RecoverPasswordToken", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { -1, 0, true, "ad8f7307-051b-4939-b137-1e685af77e31", new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "info@bomsite.com", true, null, false, null, true, "TopCenter", "Bomsite", "INFO@BOMSITE.COM", "INFO@BOMSITE.COM", "AQAAAAEAACcQAAAAEMGIVnbRp0Jwh2TNZwR2SRnuXxDZ6n+BfbsXhIvWUuBxBa+7nFzYPD++BzjvdKw/Lw==", null, false, null, null, "V3A7AYPV5U2QVNZ4H324NRXI42PDZRSW", false, "info@bomsite.com" });
